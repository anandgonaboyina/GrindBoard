        ...
        <div id="nav-dock" className="relative flex items-center justify-between sm:justify-center gap-2 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl sm:rounded-3xl glass-panel before:absolute before:inset-0 before:-z-10 before:rounded-2xl sm:before:rounded-3xl before:bg-gradient-to-b before:from-white/10 before:to-transparent pointer-events-auto w-[calc(100vw-24px)] sm:w-auto max-w-full sm:max-w-none">
            ...
            <Tooltip text="Google Translate" position="top">
                <button
                    ...
                    className="group relative flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-[#ffffff] text-[#4285F4] shadow-lg transition-all duration-300 hover:scale-[1.2] hover:-translate-y-2 hover:shadow-2xl cursor-pointer"
                >
                    <svg className="group-hover:scale-125 transition-transform duration-300 w-6 h-6 sm:w-8 sm:h-8" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Tooltip text="Google Keep" position="top">
                ...
                >
                    <svg className="group-hover:scale-125 transition-transform duration-300 w-6 h-6 sm:w-8 sm:h-8 text-white drop-shadow-sm" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Tooltip text="WhatsApp" position="top">
                ...
                >
                    <svg className="group-hover:scale-125 transition-transform duration-300 w-6 h-6 sm:w-8 sm:h-8 fill-current drop-shadow-sm" viewBox="0 0 24 24">
            ...
            {/* Telegram */}
            <Tooltip text="Telegram" position="top">
                <button
                    onClick={() => window.open('tg://', '_blank')}
                    className="group relative flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-[#24A1DE] text-white shadow-lg transition-all duration-300 hover:scale-[1.2] hover:-translate-y-2 hover:shadow-2xl cursor-pointer"
                >
                    <svg className="group-hover:scale-125 transition-transform duration-300 w-6 h-6 sm:w-8 sm:h-8 fill-current drop-shadow-sm" viewBox="0 0 24 24">
